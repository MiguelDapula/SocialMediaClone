  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="">
        <div class="text-center">
         <span  class="modal-title font-weight-bold text-center" id="exampleModalLongTitle">
          <span style="font-size: 20px;">Hello! <span style="color:#207ce5"><?php echo $user->name; ?></span>  </span>  
         </span>
        </div>
      ...
      <div class="modal-body">
        ...
        <h4 style="font-weight: 600; " >You have logged in successfully!</h4>
 
        </div>
        <p>The clone project comprises features such as posting tweets,
           retweeting, liking tweets, commenting on tweets (including nested comments), quoting tweets (including nested quotes),
            and mentioning other users or adding hashtags to your tweets. Additionally, you have the ability to modify your password or username,
             follow or unfollow other users, receive notifications for any actions, and search for users based on their name or username, among other functionalities.
        </p>
      </div>
    ...
    <div class="wrapper-left">
      ...
      <div class="grid-posts">
        ...
        <div class="wrapper-right">
          ...
          <input type="text" class="form-control search-input"  placeholder="Search Twitsy">
          ...
          <div class="box-share">
            <p class="txt-share"><strong>Follow you friends!</strong></p>
            <?php 
