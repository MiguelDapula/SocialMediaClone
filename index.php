            ...
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        ...
                        <span class="front-para">Do you want to know what's happening on the world right now?</span>
                        <span class="join">Become a Twitsy member today!!.</span>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 style="font-weight: 700;" class="modal-title" id="exampleModalLongTitle">You wont regret this. Sign up now!</h5>
