...
<body>
    ...
    <div class="wrapper-left">
      ...
      <div class="grid-posts">
          ...
          <div class="box-home feed">
               <div class="container">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <a style="color:black !important;" class="nav-link active text-center" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Change Email and Username</a>
       ...
       <div class="box-share">
            <p class="txt-share"><strong>Follow your friends!</strong></p>
            <?php 
